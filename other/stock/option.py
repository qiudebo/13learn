...
_default= dict(reload_data='Y',
    ...
    store_path='./tmp/stockholm_export',
    thread=10,
...
parser.add_argument('--storepath',type=str,default=_default['store_path'],dest='store_path',help='Data file store path,Default:%s'%_default['end_date'])
...
parser.add_argument('--dbname',type=str,default=_default['db_name'],dest='db_name',help='MongoDB name,Default:%s'%_default['db_name'])
